...
(function () {
  ...
  const dict = {
    ru: {
      ...
      hero_subtitle: 'Донаты, Telegram Stars и Premium в одном магазине',
  ...
  const extra = {
    ru: {
      ...
      hero_subtitle: 'Баланс, автоплатежи HUMO и моментальная отправка поставщику.',
      topup: 'Пополнить',
    ...
    en: {
      ...
      hero_subtitle: 'Wallet balance, HUMO auto-payments and instant supplier delivery.',
      topup: 'Top Up',
    ...
    uz: {
      ...
      hero_subtitle: 'Balans, HUMO avto-to‘lovlari va yetkazuvchiga tez yuborish.',
      topup: 'To‘ldirish',
