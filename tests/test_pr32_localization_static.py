...
class PR33OrderSuccessStaticTests(unittest.TestCase):
    ...
    def test_paid_order_confirmation_cache_busters_updated(self):
        self.assertIn("css/style.css?v=202606272034", self.index)
        self.assertIn("js/i18n.js?v=202606272034", self.index)
        self.assertIn("js/app.js?v=202606272034", self.index)
